...
const Navbar: React.FC = () => {
  ...
  useEffect(() => {
    productService.getAllProducts({ limit: 500 }) 
        .then(response => {
            ...
            <div className="hidden lg:flex items-center space-x-4">
              ...
              {user ? (
                <div className="relative">
                  ...
                  >
                      <div className="px-4 py-2 text-sm text-gray-700 border-b">Signed in as <strong className="block">{user.name}</strong></div>
